...
import { Sprout, ShieldCheck, Tractor, CloudSun } from 'lucide-react';
    ...
    <div className="flex w-full max-w-5xl overflow-hidden rounded-3xl border border-white/20 bg-white/5 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-black/20 md:min-h-[600px] lg:flex-row flex-col">
      ...
      <div className="relative flex flex-col justify-between bg-gradient-to-br from-emerald-800 via-emerald-900 to-green-950 p-8 text-white lg:w-1/2 w-full">
        ...
        <div className="relative z-10 my-12 flex flex-col gap-6">
          ...
          >
            Inteligencia y Gestión Agrícola en un solo lugar.
          </motion.h1>
          <p className="text-emerald-100/80 font-sans leading-relaxed">
            Accede a tu cuenta y gestiona de forma centralizada tu personal, inventarios, maquinaria, labores del campo y pronósticos del clima.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-emerald-100/90">Aislamiento de Datos Multiempresa RLS</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10">
                <Tractor className="h-5 w-5 text-emerald-400" />
              </div>
              <span className="text-sm font-medium text-emerald-100/90">Gestión de Flota y Mantenimiento</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/10">
                <CloudSun className="h-5 w-5 text-emerald-400" />
              </div>
              <span className="text-sm font-medium text-emerald-100/90">Monitoreo Climático Satelital</span>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col items-center justify-center p-8 bg-white/40 dark:bg-black/10 lg:w-1/2 w-full">
        <SignIn
          appearance={{
            elements: {
